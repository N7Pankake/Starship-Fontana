 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_BACKGROUND, SFASSET_WALL, SFASSET_PROJECTILE, SFASSET_ALIENPROJECTILE, SFASSET_ALIEN, SFASSET_COIN};
...
public:
  ...
  virtual void      GoSouthBullet();
  virtual void      GoSouth();
  virtual void      AlienMovementRight();
  virtual void      AlienMovementLeft();
  virtual void      AlienMovementNorth();
  virtual void      AlienMovementSouth();
